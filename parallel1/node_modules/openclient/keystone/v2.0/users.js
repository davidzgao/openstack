...
var UserManager = base.Manager.extend({
  ...
  update_password: function (params, callback) {
    base_url = this.get_base_url(params);
    params.url = base_url + "/" + params.id;
    this.client.patch(params, callback);
  },
  ...
  listProjects: function (params, callback) {
    base_url = this.get_base_url(params);
    params.url = base_url + "/" + params.id + "/projects";
