...
var QuotaClassManager = base.Manager.extend({
  namespace: "os-quota-class-sets",
  singular: 'quota_class_set',
  plural: 'quota_class_sets',

  _quota_names: ["volumes", "gigabytes"],

  updateQuota: function (params, callback) {
...
module.exports = QuotaClassManager;
