...
function _image_meta_to_headers(data) {
  var headers = {},
      non_meta_props = ['name', 'is_public', 'disk_format',
                        'min_disk', 'min_ram',
                        'container_format', 'protected'];
  ...
  if(data.copy_from) {
      headers['x-glance-api-copy-from'] = data.copy_from;
  }
...
var ImageManager = base.Manager.extend({
  ...
  create: function (params, callback) {
    ...
    var copy_from = params.data.copy_from;
    params.method = "POST";
    ...
    delete params.data;
    if(copy_from) {
      manager.client.request(params, callback);
      return;
    }
    ...
    uploader.callback = function (err, result, status) {
       manager.safe_complete(err, result, {status: status}, params, callback);
    }
  ...
  download: function(params) {
    ...
    return this._downloadBinaryStream(params, params.headers, this.client.scoped_token.id);
  },
