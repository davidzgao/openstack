var v2_client                      = require("../v2.0/client"),
    ...
    RegionManager                  = require("./regions");
    ProjectsUserBelongsToManager   = require("./projects_user_belongs_to");
    UserGroupsManager              = require("./user_groups.js");
...
var Keystone = v2_client.extend({
  ...
  init: function (options) {
    ...
    this.projects_user_belongs_to = new ProjectsUserBelongsToManager(this);
    this.user_groups         = new UserGroupsManager(this);
