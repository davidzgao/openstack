...
var AZManager = require("./availability_zones"),
    ...
    FloatingIPBulkManager = require('./floating_ip_bulk'),
    ...
    ClusterManager = require('./clusters'),
    ServiceManager = require('./services'),
    HypervisorManager = require('./hypervisors'),
    ServerManager = require("./servers"),
    UsageManager = require("./usage");
