...
angular.module('Cross.admin.metering')
  .controller 'admin.metering.MeteringCtr', ($scope, $window, $http, $q, $tabs) ->
        ...
        .then (values) ->
          if values[0] and values[1]
            ...
            for event, index in data
              ...
              dictTraits['totalPrice'] = 0  #add by davidzgao
    ...
    $scope.columnDefs = [
      {
        ...
        cellTemplate: '<div class="ngCellText"><a ui-sref="admin.metering.instanceDetail({ \
