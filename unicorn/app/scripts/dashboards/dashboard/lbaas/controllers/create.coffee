...
angular.module('Unicorn.dashboard.lbaas')
  .controller 'dashboard.lbaas.LBCreateCtr', ($scope, $http,
  ...
  .controller 'dashboard.lbaas.lbActionCtr', ($scope) ->
    return
  .controller 'dashboard.lbaas.vipAction', ($scope, $http,
  $window, $state, $q, $stateParams) ->
  ...
  .controller 'dashboard.lbaas.memberAction', ($scope, $http,
  $window, $state, $q, $stateParams) ->
    $scope.note = {
      cancel: _("Cancel")
      save: _("Update")
...
class LBMemberModal extends $unicorn.Modal
  title: "Member Manage"
  slug: "member_manage"
  single: true
  modalLoading: true
...
class VIPEditModal extends $unicorn.Modal
  title: 'VIP Manage'
  slug: 'vip_manage'
  single: true
  modalLoading: true
...
class LBCreateModal extends $unicorn.Modal
